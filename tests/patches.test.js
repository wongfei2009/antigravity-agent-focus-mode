...
test('maximize patch grows the auxiliary bar by the editor width', () => {
    const source = [
        ...
        'this.nb.setRuntimeValue(tr.AUXILIARYBAR_WAS_LAST_MAXIMIZED,!0),this.ec=!0;try{e.auxiliaryBarVisible||this.gc(!1);',
        'const i=this.H.getViewSize(this.P).width;this.nb.setRuntimeValue(tr.AUXILIARYBAR_LAST_NON_MAXIMIZED_SIZE,i),',
        'e.sideBarVisible&&this.ac(!0),e.panelVisible&&this.dc(!0),e.editorVisible&&this.$b(!0),',
        'this.nb.setRuntimeValue(tr.AUXILIARYBAR_LAST_NON_MAXIMIZED_VISIBILITY,e)}finally{this.ec=!1}}}'
    ].join('');
