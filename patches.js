const PATCHES = [
    {
        ...
        old: 'const i=this.H.getViewSize(this.P).width;this.nb.setRuntimeValue(qs.AUXILIARYBAR_LAST_NON_MAXIMIZED_SIZE,i),e.sideBarVisible&&this.ac(!0),e.panelVisible&&this.dc(!0),e.editorVisible&&this.$b(!0),this.nb.setRuntimeValue(qs.AUXILIARYBAR_LAST_NON_MAXIMIZED_VISIBILITY,e)',
        new: 'const i=this.H.getViewSize(this.P),n=e.editorVisible?this.H.getViewSize(this.Q).width:0;this.nb.setRuntimeValue(qs.AUXILIARYBAR_LAST_NON_MAXIMIZED_SIZE,i.width),e.sideBarVisible&&this.ac(!0),e.panelVisible&&this.dc(!0),e.editorVisible&&this.$b(!0),this.H.resizeView(this.P,{width:i.width+n,height:i.height}),this.nb.setRuntimeValue(qs.AUXILIARYBAR_LAST_NON_MAXIMIZED_VISIBILITY,e)',
    },
    {
